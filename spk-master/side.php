        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">TANYA LAPTOP</li><!-- /.menu-title -->
                    ...
                    <li class="menu-title">Refernsi</li>
                    <li>
                        <a href="widgets.php"> <i class="menu-icon fa fa-book"></i>Widgets </a>
                    </li>
                   
                    </li>
                    <li class="menu-title">Tambah Laptop</li>
                    <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-glass"></i>Laptop</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-sign-in"></i><a href="login.php">Tambah Laptop</a></li>
